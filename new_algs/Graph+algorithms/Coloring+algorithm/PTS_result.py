...
def square_grid_partcol_pcoloring(m, n, nbr_it):
    g = gt.lattice([m, n])
...
def dist_graph_partcol_pcoloring(k, t, size, nbr_it):
    g = distance_graph((k, t), size)
    setattr(g, "name", "D({0},{1})".format(k, t))
    kwargs = {"k_count": 3, "tt_a": 10, "tt_d": 0.5,
              "max_iter": 1000, "count_max": 5}
    return benchmark_function(g, nbr_it, partial_pack_col, **kwargs)
...
# square_grid_partcol_pcoloring(24, 40)
[square_grid_rpartcol_pcoloring(i, j, 1) for i in range(11, 14) for j in range(13, 25)]

# --- Distance graphes --- #
# Packing chromatic number already met
# dist_graph_partcol_pcoloring(2, 3, 240, 30)
# dist_graph_partcol_pcoloring(3, 5, 192, 30)
# dist_graph_partcol_pcoloring(1, 4, 320, 10)
# dist_graph_partcol_pcoloring(1, 5, 1028, 10)

# Small sized instances

# dist_graph_partcol_pcoloring(1, 6, 2016, 10)
# dist_graph_partcol_pcoloring(1, 7, 640, 10)
# dist_graph_partcol_pcoloring(1, 8, 5184, 10)
# dist_graph_partcol_pcoloring(1, 9, 576, 10)

# dist_graph_partcol_pcoloring(2, 5, 336, 10)
# dist_graph_partcol_pcoloring(2, 7, 2376, 10)
# dist_graph_partcol_pcoloring(2, 9, 4224, 10)

# dist_graph_partcol_pcoloring(3, 4, 672, 10)
# dist_graph_partcol_pcoloring(3, 7, 8720, 10)
# dist_graph_partcol_pcoloring(3, 8, 6636, 10)
# dist_graph_partcol_pcoloring(3, 10, 3120, 10)

# dist_graph_partcol_pcoloring(4, 5, 972, 10)
# dist_graph_partcol_pcoloring(4, 7, 7040, 10)
# dist_graph_partcol_pcoloring(4, 9, 3952, 10)

# dist_graph_partcol_pcoloring(5, 6, 1584, 10)
# dist_graph_partcol_pcoloring(5, 7, 768, 10)
# dist_graph_partcol_pcoloring(5, 8, 2496, 10)
# dist_graph_partcol_pcoloring(5, 9, 792, 10)

# dist_graph_partcol_pcoloring(6, 7, 1716, 10)

# dist_graph_partcol_pcoloring(7, 8, 6720, 10)
# dist_graph_partcol_pcoloring(7, 9, 768, 10)
# dist_graph_partcol_pcoloring(7, 10, 24480, 10)

# dist_graph_partcol_pcoloring(8, 9, 51751, 10)

# dist_graph_partcol_pcoloring(9, 10, 15048, 10)
