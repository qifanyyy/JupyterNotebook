...
class MainFace(object):
    ...
    def __init__(self, root):
        ...
        button1 = tk.Button(self.face, text='单张图片颜色选取', bg='#D2F99A', \
                            width=20, height=8, \
                            command=self.change1)
        button1.place(x=160, y=320)
        button2 = tk.Button(self.face, text='双张图片颜色选取', bg='#F9CBF0', \
                            width=20, height=8, \
...
class SingleFace(object):
    ...
    def __init__(self, root):
        ...
        l1 = tk.Label(self.face, text='请选择图片：', \
    ...
    def main(self):
        ...
        # write to list box
        sum_area = 0.0
        info = ' '*5 + '序号' + ' '*28 + 'LAB' + ' '*50 + '面积占比' + ' '*45 + '军标色号'
...
class DoubleFace(object):
    ...
    def save_excel(self):
        ...
        try:
            ...
            sheet.cell(1,3).value = '背景图片一'
            sheet.cell(1,5).value = '背景图片二'
