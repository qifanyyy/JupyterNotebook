...
X = df.ix[:,[ #'Weekday',  #7
            ...
            'Check Ticket', 'Resource6',  # f 3 2 33 43
             'Decide', 'Resource9', #i 4 2 39     51
            'Accept', 'Resource10', #j 2 2 43 57
            'Reject', 'Resource11', #k 2 2 47 63
            'Reapply', 'Resource12']].values  #l 2 2 51 69
X2 = df.ix[:,['Duration4','Cost4', 'Duration5','Cost5', 'Duration7','Cost7', 'Duration8','Cost8','Duration6', 'Cost6', 'Duration9','Cost9','Duration10','Cost10','Duration11','Cost11','Duration12','Cost12',]].values
y = df['Result2'].values
#one-hot编码
enc = OneHotEncoder()
enc.fit(X)
