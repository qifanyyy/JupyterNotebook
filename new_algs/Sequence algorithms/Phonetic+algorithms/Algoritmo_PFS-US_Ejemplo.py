...
#	$ python Algoritmo_PFS-US_Ejemplo.py <archivo_de_reglas>

#Ejemplo de uso concreto:

#	$ python Algoritmo_PFS-US_Ejemplo.py REGLAS/reglas_pfs-us.txt

#Este programa implementa el algoritmo PFS en una palabra de entrada por medio de la
#funcion codigo_pfs_us()
...
print  codigo_pfs_us(lista_reglas,"preproducción")
print  codigo_pfs_us(lista_reglas,"preproducciOn")
