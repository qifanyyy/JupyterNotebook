...
#     plt.savefig ('Unfiltered_25.jpg')
    ...
    msec_intervals = 1000*(rr_intervals)
#     plt.xlabel("Beat number")
#     plt.ylabel("RR intervals/msec")
#     plt.plot(rr_x, msec_intervals)
#     plt.savefig ('RR.jpg') 
    return (msec_intervals,timestamps)        
...
#     ecg_plot(smoothed)
    ...
    msec_intervals,timestamps = final_plot(smoothed,threshold)
    return (msec_intervals,timestamps)

if __name__ == "__main__":
    #read the ECG signal values into a np array
    ecg_signal = np.loadtxt(fname = "DataN.txt")
#     msec_intervals,timestamps = qrs_detect(ecg_signal, 5)
#     msec_intervals,timestamps = qrs_detect(ecg_signal,15)
    msec_intervals,timestamps = qrs_detect(ecg_signal,25)
