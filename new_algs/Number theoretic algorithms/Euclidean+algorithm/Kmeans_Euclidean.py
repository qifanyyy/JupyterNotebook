...
class KMeansEuclidean:
    ...
    def euclidean_distance(self, u, v):
        ...
        -------
        float
            Euclidean distance between arrays u and v.
        """
        return np.sqrt(np.sum(np.square(u - v)))

    def fit(self, dataset):
        """Computes k means clustering using Euclidean distance.
        ...
        #random k elements in the dataset are the initial self.centroids
