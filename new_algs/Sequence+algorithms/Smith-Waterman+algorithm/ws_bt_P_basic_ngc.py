...
"""
    classic iterative implementation with reverse calculation, no extended gap penalty, no endgap penalty, garbage collector disabled
"""

import numpy as np
import sys, psutil, os, gc, time
