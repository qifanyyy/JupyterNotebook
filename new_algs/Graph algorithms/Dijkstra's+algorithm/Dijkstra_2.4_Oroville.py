...
nodesCSV = r'C:\Users\591943\Documents\GitHub\TeamYoung\mosul_dam\data\arcgisNodesOutput'
    
nodes = pd.read_csv(nodesCSV + r'.csv')
roads = pd.read_csv(r'C:\Users\591943\Documents\GitHub\TeamYoung\mosul_dam\data\roadsWithNodes.csv')

a = list(roads.IN)
b = list(roads.OUT)
distance = list(roads.Shape_Length)
...
def find_all_shortest_paths(destination):
    ...
    pathsDict = {k:[] for k in nodes.OBJECTID}
    distDict = {l:[] for l in nodes.OBJECTID}
    #dest = destination

    for node in nodes.OBJECTID:
        pack = {}
        pack2 = {}
