...
QUERY = "jupyter+notebook" #The personalized query (for instance, to get repositories from user 'rsain')
SUBQUERIES = [] #Different subqueries if you need to collect more than 1000 elements
PARAMETERS = "&per_page=100" #Additional parameters for the query (by default 100 items per page)
DELAY_BETWEEN_QUERYS = 11 #The time to wait between different queries to GitHub (to avoid be banned)
OUTPUT_FOLDER = "/Users/yuqifan/Documents/GitHub/JupyterNotebook" #Folder where ZIP files will be stored
